        ...
        <div className="p-2 flex  flex-col justify-center " style={{width:"400px"}}>
          <div className='flex flex-col m-3 border-2 border-gray-500 p-4'>
              ...
              <div className=" flex flex-col  justify-center px-4" >
                <input type="email" placeholder="Email" className="input-1 mb-5 py-2 px-4 border-gray-400 border-1 rounded bg-gray-100" value={email} onChange={(e)=>setEmail(e.target.value)} />
                <input type="password" placeholder="Password" className="input-2 mb-5 py-2 px-4 border-gray-400 border-1 rounded bg-gray-100" value={password} onChange={(e)=>setPassword(e.target.value)} />
                {
                  loding ? 
                  ...
                  :
                  <button type="button" className="bg-sky-500 mb-5 py-2 px-4 border-gray-400 border-1 rounded" onClick={signinUser} >Log in</button>
              ...
              <div>
                ...
                <div className='flex justify-center m-2'>
                  <button className='bg-sky-500 mb-5 py-2 px-4 border-gray-400 border-1 rounded'><FacebookIcon /> Log in with Facebook</button>
                </div>
